 ...
 * This does not change the object class for existing files or dirs, or the
 * dir this is called on. Note that this is only supported on directories.
 *
 * \param[in]   dfs     Pointer to the mounted file system.
 * \param[in]   obj	Open object to access.
 ...
 * This does not change the chunk size for existing files or dirs, or the
 * dir this is called on. Note that this is only supported on directories.
 *
 * \param[in]   dfs     Pointer to the mounted file system.
 * \param[in]   obj	Open object to access.
 * \param[in]   csize	chunk size.
 *
 * \return		0 on success, errno code on failure.
 */
int
